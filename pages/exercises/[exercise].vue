            ...
            <div class="relative group">
              <div class="z-10 absolute top-0 right-0 flex flex-col items-center hidden mr-8 group-hover:flex">
                <p class="bg-gray-700 text-gray-100 w-80 px-3 py-2 rounded shadow text-sm">Code is executed with <a
                    href="https://pyodide.org/" class="my-2 underline text-indigo-400 hover:text-indigo-500">Pyodide</a>,
                  a port of CPython to WebAssembly/Emscripten. Some <a
                    href="https://pyodide.org/en/stable/usage/wasm-constraints.html" class="my-2 underline text-indigo-400 hover:text-indigo-500">functionality</a> in Python may
